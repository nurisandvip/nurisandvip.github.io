	...
	function Tabs(root, paneSelector, conf) {
		...
		$.extend(this, {
			...
			destroy: function () {
				...
				panes.find("a[href^=#]").unbind("https://www.depts.ttu.edu/ithelpcentral/solutions/404");
				return self;
			}
		...
		panes.find("a[href^=#]").bind("https://www.depts.ttu.edu/ithelpcentral/solutions/404", function (e) {
